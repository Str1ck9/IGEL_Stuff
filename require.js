...
(function(ba) {
    ...
    function J(b) { return "[object Function]" === N.call(b); }
    ...
    function t(b, c) { return ha.call(b, c); }
    ...
    function S(b, c, d, m) {
        c && H(c, function(c, l) {
            if (d || !t(b, l))
                m && "string" !== typeof c ? (b[l] || (b[l] = {}), S(b[l],
                    c, d, m)) : b[l] = c;
        });
        return b;
    }
    ...
    function ia(b) {
        ...
        function l(a,
            ...
            a = a[1];
            i && (i = c(i, d, e), D = m(r, i));
            a && (i ? j = D && D.normalize ? D.normalize(a, function(a) { return c(a, d, e); }) : c(a, d, e) : (j = c(a, d, e), a = g(j), i = a[0], j = a[1], b = !0, n = k.nameToUrl(j)));
        ...
        function w(a, f) {
            ...
            if (f) f(a);
            else if (z(b, function(f) { if (f = m(q, f)) f.error = a, f.events.error && (e = !0, f.emit("error", a)); }), !e) h.onError(a);
        }
        ...
        function E() {
            ...
            if (!X) {
                ...
                if (n && c.length)
                    return b = B("timeout", "Load timeout for modules: " + c, null, c), b.contextName =
                        k.contextName, w(b);
        ...
        P = {
            require: function(a) { return a.require ? a.require : a.require = k.makeRequire(a.map); },
            exports: function(a) {
                a.usingExports = !0;
        ...
        $.prototype = {
            ...
            callPlugin: function() {
                ...
                u(d, "defined", v(this, function(e) {
                    ...
                    if (this.map.unnormalized) {
                        if (e.normalize && (d = e.normalize(d, function(a) { return c(a, g, !0); }) || ""), e = l(a.prefix + "!" + d, this.map.parentMap), u(e, "defined", v(this, function(a) { this.init([], function() { return a; }, null, { enabled: !0, ignore: !0 }); })),
                        d = m(q, e.id)) {
                            this.depMaps.push(e);
                        ...
                        n = v(this, function(a) { this.init([], function() { return a; }, null, { enabled: !0 }); }), n.error = v(this, function(a) {
                            this.inited = !0;
                            this.error = a;
                            a.requireModules = [b];
            ...
            emit: function(a, b) {
                z(this.events[a], function(a) { a(b); });
        ...
        k = {
            ...
            completeLoad: function(a) {
                var b, c, e = m(j.shim, a) || {}, d = e.exports;
                for (x(); I.length;) {
                    c = I.shift();
                    if (null === c[0]) {
                        c[0] = a;
    ...
    x = Object.prototype;
    var N = x.toString, ha = x.hasOwnProperty, ja = Array.prototype.splice, A = !!("undefined" !== typeof window && navigator && window.document), ea = !A && "undefined" !== typeof importScripts, la = A && "PLAYSTATION 3" === navigator.platform ? /^complete$/ : /^(complete|loaded)$/, Z = "undefined" !== typeof opera && "[object Opera]" === opera.toString(), G = {}, u = {}, U = [], Q =
        !1;
    if ("undefined" === typeof define) {
        ...
        h.load = function(b, c, d) {
            var h = b && b.config || {}, g;
            if (A)
                return g = h.xhtml ? document.createElementNS("http://www.w3.org/1999/xhtml",
        ...
        define = function(b, c, d) {
            ...
            K(c) || (d = c, c = null);
            !c && J(d) && (c = [], d.length && (d.toString().replace(ma, "").replace(na, function(b, d) { c.push(d); }), c = (1 === d.length ? ["require"] : ["require", "exports", "module"]).concat(c)));
            if (Q) {
                if (!(h = M)) R && "interactive" === R.readyState || O(document.getElementsByTagName("script"), function(b) { if ("interactive" === b.readyState) return R = b; }), h = R;
